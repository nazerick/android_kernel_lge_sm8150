...
/* Tunables */
static const int sync_read_expire = 80;	/* max time before a read sync is submitted. */
static const int sync_write_expire = 140;	/* max time before a write sync is submitted. */
static const int async_read_expire = 50;	/* ditto for read async, these limits are SOFT! */
static const int async_write_expire = 100;	/* ditto for write async, these limits are SOFT! */
static const int fifo_batch = 56;		/* # of sequential requests treated as one by the above parameters. */
static const int writes_starved = 1;		/* max times reads can starve a write */
static const int sleep_latency_multiple = 6;	/* multple for expire time when device is asleep */
